...
export const standardTicketTemplate: WeighingTicketTemplate = {
  ...
  fields: ["logo", "dateTime", "operator", "balanceName", "rawBalanceLine", "weight", "lotNumber", "sampleId", "signature", "qrCode"],
...
export const ticketTemplates: WeighingTicketTemplate[] = [
  standardTicketTemplate,
  {
    ...
    companyName: "LabConnect",
    title: "BON DE PESÉE",
    fields: ["logo", "dateTime", "operator", "balanceName", "grossWeight", "tareWeight", "netWeight", "lotNumber", "sampleId", "signature", "qrCode"],
  ...
  },
  {
    ...
    fields: ["companyName", "ticketTitle", "dateTime", "operator", "lotNumber", "sampleId", "balanceName", "rawBalanceLine", "resultStatus", "signature", "qrCode"],
